...
const PoliticleWorld = () => {
  ...
  return (
    <div className="news-sports-container">
      {/* ---------------------------------News sports---------------------------------*/}
      <>
        <div className="news-sports-content">
          <div className="news-header">Sports</div>
              ...
              <div key={id}>
                <Link to="/detailed-news">
                  <div className="list-wrapper">
                    <div className="news-sports-img-box">
                      <img src={item?.img} alt="img" />
                    </div>
                    <div className="list-content">
                      <div className="sports-list-headline">
                        {item?.headline}
                      </div>
                    </div>
                  </div>
      ...
      <>
        ...
        <div className="news-sports-inner-wrapper">Pending...</div>
      </>
      {/* ---------------------------------The Movies--------------------------------- */}
      <>
        <div className="news-sports-content">
