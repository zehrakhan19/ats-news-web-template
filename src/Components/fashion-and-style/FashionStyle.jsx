  ...
  return (
    <div className="news-podcast-container">
      ...
      <>
        ...
        <div className="news-podcast-inner-wrapper">
          <div className="news-podcast-one">
            <div className="news-podcast-img-box">
              <img src={data[0]?.img} alt="img" />
            </div>
          </div>
          <div className="news-podcast-two">
            <div className="news-podcast-two-inner">
              <div className="news-podcast-two-chip">News in brief</div>
              <div>{data[0]?.timespan.split(" ").slice(0, 2).join(" ")}</div>
              <div>{data[0]?.timespan.split(" ").slice(2).join(" ")}</div>
            </div>
            <Link to="/detailed-news">
              <h9 className="list-headline">
                {data[0]?.article.split(" ").slice(0, 10).join(" ") + "..."}
              </h9>
            </Link>
          </div>
        </div> */}
      ...
      <>
        <div className="news-podcast-content">
          <div className="news-header">Photo Stories</div>
          <div className="line-orange"></div>
        </div>
        <div className="news-podcast-inner-wrapper">Pending...</div>
      </>
      {/* ---------------------------------The Movies--------------------------------- */}
      <>
        <div className="news-podcast-content">
          <div className="news-header">The Movies</div>
          <div className="line-orange"></div>
        </div>
